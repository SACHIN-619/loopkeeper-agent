...
[![Gemini](https://img.shields.io/badge/Gemini-3.5%20Flash-green)](https://ai.google.dev/)
...
| Language Model | Gemini 3.5 Flash (`gemini-3.5-flash` via `GOOGLE_API_KEY`) |
...
- ✅ **Gemini 2.0 Flash**: Reasoning + Gemini Vision for invoice extraction
